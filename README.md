...
│   ├── app.py                  ← FastAPI: POST /predict/risk, GET /health
│   ├── data/
│   │   ├── raw/insurance_data.csv
...
python agents/agent1_risk_profiler.py   # train + export artifacts
uvicorn app:app --reload --port 8000    # start API
...
## Agent 1 – Risk Profiler v3 · Full Documentation
